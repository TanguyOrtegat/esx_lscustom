...
Config.Zones = {
    ls1 = {
        Pos   = {x = -223.53680419922,y = -1329.2813720703,z = 29.890390396118 },
...
Config.Menus = {
	...
	modEngine = {
		...
		parent = 'upgrades',
		modType = 11,
		price = {3000, 5000, 8000, 12000}
	},
	modBrakes = {
		label = _U('brakes'),
		parent = 'upgrades',
		modType = 12,
		price = {4000, 5000, 6000, 7000}
	},
	modTransmission = {
		label = _U('transmission'),
		parent = 'upgrades',
		modType = 13,
		price = {3500, 5000, 10000}
	},
	modSuspension = {
		label = _U('suspension'),
		parent = 'upgrades',
	...
	modArmor = {
		...
		parent = 'upgrades',
		modType = 16,
		price = {5000, 10000, 15000, 20000, 25000, 30000}
	},
	modTurbo = {
		label = _U('turbo'),
		parent = 'upgrades',
